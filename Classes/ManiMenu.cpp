...
bool MainMenu::init(){
    ...
    auto btt1Label = Label::createWithTTF("Join Local Game", "fonts/Marker Felt.ttf", 20);
...
//    btt4->addChild(btt4Label);
    ...
    auto btt5Label = Label::createWithTTF("Create Local Game", "fonts/Marker Felt.ttf", 20);
